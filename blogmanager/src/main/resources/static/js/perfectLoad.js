...
jQuery.bootstrapLoading = {
    start: function (options) {
        ...
        //当页面加载完成后执行
        function PageLoaded() {
            if (document.readyState == "complete" && options.autoClose) {
